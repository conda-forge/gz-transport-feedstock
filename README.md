...
pixi add gz-transport gz-transport-python gz-transport13 gz-transport13-python libgz-transport libgz-transport13
# for installing globally
pixi global install gz-transport gz-transport-python gz-transport13 gz-transport13-python libgz-transport libgz-transport13
```
