...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-transport-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-transport-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gz-transport gz-transport-python gz-transport14 gz-transport14-python libgz-transport libgz-transport14
# for installing globally
pixi global install gz-transport gz-transport-python gz-transport14 gz-transport14-python libgz-transport libgz-transport14
```
...
It is possible to list all of the versions of `gz-transport` available on your platform:
...
```
pixi search gz-transport --channel conda-forge
```
